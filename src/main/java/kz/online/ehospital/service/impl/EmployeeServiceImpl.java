...
import kz.online.ehospital.repository.EmployeeRepository;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    public Employee findByFullName(String firstname, String  name, String patronymic) {
        return employeeRepository.findByFullName(firstname,  name, patronymic);
    }
